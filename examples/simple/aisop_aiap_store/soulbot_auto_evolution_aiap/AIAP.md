...
tools:
  ...
  - name: web_browser
    ...
    annotations:
      ...
      open_world: true
modules:
  - id: soulbot_auto_evolution.main
    file: main.aisop.json
    nodes: 20
    critical: true
    idempotent: false
    side_effects: [file_write]
  - id: soulbot_auto_evolution.planner
    file: planner.aisop.json
    nodes: 9
    critical: true
    idempotent: true
    side_effects: []
  - id: soulbot_auto_evolution.executor
    file: executor.aisop.json
    nodes: 6
    critical: true
    idempotent: false
    side_effects: [file_write]
  - id: soulbot_auto_evolution.validator
...
# Optional Fields
governance_hash: a3e4608c8e35df75341aa856a629959d3f81f7fb637c3ac94932fc2bd25a8871
quality:
...
capabilities:
  ...
  required:
    - file_read
tool_dirs:
  - path: "AIAP_Tools/soulbot_creator_evolution_aiap"
    type: "aiap_program"
    trust_level: "T4"
...
applicability_condition:
  ...
  preconditions:
    ...
    - "AIAP_Tools/soulbot_creator_evolution_aiap/ directory contains valid Creator"
  exclusions:
...
|------|---------|---------|
| soulbot_creator_evolution_aiap | v1.24.0 | Nested Creator for single-round evolution execution via intent execution |
...
- AIAP_Tools/soulbot_creator_evolution_aiap/ contains valid Creator v1.24.0
